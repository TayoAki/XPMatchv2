...
| 4 | Profile and site | Independent: **13/20** (15 blind) | **Failed the independent grade, then revised** | Shippability 1. Unshippable placeholders; missed the public origin story; the author-similarity claim. Revised on 2026-09-23 (`eval.md`); re-grade pending |
| 5 | Content | Independent: **0/20** (kill check); 12/20 rubric | **Failed the independent grade, then revised** | A mis-cited quote and unmeasured numbers in post copy; v1's weekend guide not read. Revised on 2026-09-23 (`eval.md`); re-grade pending |
